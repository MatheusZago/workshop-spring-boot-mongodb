...
@RestController // Está dizendo que é uma classe controladora e que os métodos dela devem voltar
				// em Json
...
public class PostResources {
	...
	// Request param text é pro endpoint identificar o nome do parametro dps do
	// /titlesearch
